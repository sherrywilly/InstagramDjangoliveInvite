...
from core.views import LoginView, UserManage, addSlave, dashboard, deleteSlave, get_short_codes, insta_invite, logout_view, status_view,tester,fetch_users
...
urlpatterns = [
    ...
    path('get_shortcode/',get_short_codes,name="get_short_codes"),
]
